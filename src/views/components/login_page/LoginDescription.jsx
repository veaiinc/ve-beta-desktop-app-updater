	...
	<div className={s.loginDescriptionContainer}>
		...
		<div className={s.loginDescriptionTwo}>
			<div className={s.loginDescriptionTwoText}>
				{loginDescriptionContent.descriptionTwo.title.split('Promise.').map((part, index) =>
					index === 0 ? (
						<p key={index}>
							{part}
							<span>Promise.</span>
		...
		<div className={s.loginDescriptionThree}>{loginDescriptionContent.descriptionThree}</div>
