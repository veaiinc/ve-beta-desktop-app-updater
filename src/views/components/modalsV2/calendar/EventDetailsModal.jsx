...
import Delete from '../../../../assets/svg/tasks/dustBin.svg?react';
import Share from '../../../../assets/svg/calendar/share.svg?react';
import Call from '../../../../assets/svg/calendar/events/call.svg?react';
import Location from '../../../../assets/svg/calendar/events/location.svg?react';
import Link from '../../../../assets/svg/calendar/events/link.svg?react';
import Status from '../../../../assets/svg/calendar/events/status.svg?react';
			...
			setInfo((prev) => ({
				...
				eventDetails: {
					...
					attendees: Array.isArray(selectedEvent.attendees)
						...
						: [],
					calendarCategory: matchingCategory || selectedEvent.calendarCategory || null,
				},
