...
import '../../../assets/scss/settings/teamSettingsModal.scss';
...
const TeamSettingsModal = ({ isOpen, closeTeamSettings }) => {
	// Contexts
	const {
	...
	return (
		<ReactModal isOpen={isOpen} closeModal={closeTeamSettings} customStyles={customStyles}>
			<div className="TeamMemberContainerModal">
...
export default memo(TeamSettingsModal);
