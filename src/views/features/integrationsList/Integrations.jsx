...
const Integrations = () => {
	...
	const requestIntegrations = [
		...
		},
		{
			...
			title: 'Google Workspace (Gmail, Drive, Docs, Calendar)',
		},
		{ id: 4, iconSlug: 'slack', title: 'Slack' },
		{ id: 5, iconSlug: 'zoom', title: 'Zoom' },
		{ id: 6, iconSlug: 'confluence', title: 'Confluence (Atlassian)' },
		{ id: 7, iconSlug: 'notion', title: 'Notion' },
		...
		{ id: 15, iconSlug: 'servicenow', title: 'ServiceNow' },
		...
		{ id: 20, iconSlug: 'tableau', title: 'Tableau' },
		{ id: 21, iconSlug: 'power-bi', title: 'Power BI' },
		{ id: 22, iconSlug: 'gitlab', title: 'GitLab' },
		{ id: 23, iconSlug: 'hubspot', title: 'HubSpot' },
		{ id: 24, iconSlug: 'intercom', title: 'Intercom' },
		{ id: 25, iconSlug: 'bamboohr', title: 'BambooHR' },
		{ id: 26, iconSlug: 'greenhouse', title: 'Greenhouse' },
		{ id: 27, iconSlug: 'lattice', title: 'Lattice' },
		{ id: 28, iconSlug: 'airtable', title: 'Airtable' },
		{ id: 29, iconSlug: 'mondaycom', title: 'Monday.com' },
		{ id: 30, iconSlug: 'smartsheet', title: 'Smartsheet' },
		{ id: 31, iconSlug: 'azure-devops', title: 'Azure DevOps' },
		{ id: 32, iconSlug: 'freshdesk', title: 'Freshdesk' },
		{ id: 33, iconSlug: 'egnyte', title: 'Egnyte' },
		{ id: 34, iconSlug: 'miro', title: 'Miro' },
		{ id: 35, iconSlug: 'docusign', title: 'DocuSign' },
		{ id: 36, iconSlug: 'adp', title: 'ADP' },
		{ id: 37, iconSlug: 'zoominfo', title: 'ZoomInfo' },
		{ id: 38, iconSlug: 'gong', title: 'Gong' },
		{ id: 39, iconSlug: 'domo', title: 'Domo' },
		{ id: 40, iconSlug: 'looker', title: 'Looker' },
		{ id: 41, iconSlug: 'splunk', title: 'Splunk' },
		{ id: 42, iconSlug: 'pagerduty', title: 'PagerDuty' },
		{ id: 43, iconSlug: 'outreachio', title: 'Outreach.io' },
		{ id: 44, iconSlug: 'salesloft', title: 'Salesloft' },
		...
		{ id: 50, iconSlug: 'wrike', title: 'Wrike' },
		{ id: 51, iconSlug: 'basecamp', title: 'Basecamp' },
		{ id: 52, iconSlug: 'zoho-crm', title: 'Zoho CRM' },
		{ id: 53, iconSlug: 'pipedrive', title: 'Pipedrive' },
		{ id: 54, iconSlug: 'freshsales', title: 'Freshsales' },
		{ id: 55, iconSlug: 'help-scout', title: 'Help Scout' },
		{ id: 56, iconSlug: 'kayako', title: 'Kayako' },
		{ id: 57, iconSlug: 'front-app', title: 'Front App' },
		{ id: 58, iconSlug: 'kustomer', title: 'Kustomer' },
		{ id: 59, iconSlug: 'guru', title: 'Guru' },
		{ id: 60, iconSlug: 'slite', title: 'Slite' },
		{ id: 61, iconSlug: 'nuclino', title: 'Nuclino' },
		{ id: 62, iconSlug: 'marketo', title: 'Marketo' },
		{ id: 63, iconSlug: 'mailchimp', title: 'Mailchimp' },
		{ id: 64, iconSlug: 'braze', title: 'Braze' },
		{ id: 65, iconSlug: 'iterable', title: 'Iterable' },
		{ id: 66, iconSlug: 'adobe-creative-cloud', title: 'Adobe Creative Cloud' },
		{ id: 67, iconSlug: 'canva', title: 'Canva' },
		{ id: 68, iconSlug: 'sketch', title: 'Sketch' },
		{ id: 69, iconSlug: 'invision', title: 'InVision' },
		{ id: 70, iconSlug: 'mode-analytics', title: 'Mode Analytics' },
		{ id: 71, iconSlug: 'sisense', title: 'Sisense' },
		{ id: 72, iconSlug: 'onelogin', title: 'OneLogin' },
		{ id: 73, iconSlug: 'duo-security', title: 'Duo Security' },
		{ id: 74, iconSlug: 'jamf', title: 'Jamf' },
		{ id: 75, iconSlug: 'quickbooks-online', title: 'QuickBooks Online' },
		{ id: 76, iconSlug: 'xero', title: 'Xero' },
		{ id: 77, iconSlug: 'billcom', title: 'Bill.com' },
		{ id: 78, iconSlug: 'expensify', title: 'Expensify' },
		{ id: 79, iconSlug: 'ironclad', title: 'Ironclad' },
		{ id: 80, iconSlug: 'lucidchart', title: 'Lucidchart' },
		{ id: 81, iconSlug: 'chili-piper', title: 'Chili Piper' },
		{ id: 82, iconSlug: 'chorusai', title: 'Chorus.ai' },
		{ id: 83, iconSlug: 'clearbit', title: 'Clearbit' },
		{ id: 84, iconSlug: 'twist', title: 'Twist' },
		{ id: 85, iconSlug: 'mattermost', title: 'Mattermost' },
		{ id: 86, iconSlug: 'flock', title: 'Flock' },
		{ id: 87, iconSlug: 'redbooth', title: 'Redbooth' },
		{ id: 88, iconSlug: 'proofhub', title: 'ProofHub' },
		{ id: 89, iconSlug: 'citrix-sharefile', title: 'Citrix ShareFile' },
		{ id: 90, iconSlug: 'docker-hub', title: 'Docker Hub' },
		{ id: 91, iconSlug: 'jenkins', title: 'Jenkins' },
		{ id: 92, iconSlug: 'circleci', title: 'CircleCI' },
		{ id: 93, iconSlug: 'terraform', title: 'Terraform' },
		{ id: 94, iconSlug: 'lever', title: 'Lever' },
		{ id: 95, iconSlug: 'paylocity', title: 'Paylocity' },
		{ id: 96, iconSlug: 'gusto', title: 'Gusto' },
		{ id: 97, iconSlug: 'rippling', title: 'Rippling' },
		{ id: 98, iconSlug: 'namely', title: 'Namely' },
		{ id: 99, iconSlug: 'document360', title: 'Document360' },
		{ id: 100, iconSlug: 'helpjuice', title: 'Helpjuice' },
		{ id: 101, iconSlug: 'activecampaign', title: 'ActiveCampaign' },
	];
