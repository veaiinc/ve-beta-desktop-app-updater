		...
		<div className={s.howItWorks}>
			<div className={s.top}>
				...
				<p className={s.subTitle}>
					Unlike traditional agents, our Proactive AI doesn&apos;t wait for commands. It
					continuously ingests and understands your data, evolving and learning from every
					interaction. Without needing prompts, it identifies patterns, reasons in
					real-time, and anticipates your needs. This open-ended, self-learning approach
					transforms how you interact with AI, making it more intuitive and powerful.
				</p>
			</div>
