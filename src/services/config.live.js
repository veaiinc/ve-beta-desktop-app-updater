...
export const meeting_api = 'https://ap.api.ve.ai/meeting/1.0';
//socket endpoints
...
export const meeting_ws_api_US = 'wss://recall.us-east-1.ve.ai/frontend/ws';
export const voice_agent_api_US = 'wss://ve-ai-voice-agent-9yzwlzsg.livekit.cloud';
