		...
		switch (permissionType) {
			case 'request':
				return {
					...
					message: 'Ve AI needs access to your microphone to enable voice transcription and live intelligence features.',
					steps: [
			...
			case 'denied':
				return {
					...
					message: 'Microphone access was previously denied. To enable voice features, you\'ll need to manually allow microphone access.',
					steps: [
			...
			case 'system':
				return {
					...
					message: 'Ve AI needs system-level microphone permission. Please enable it in your system settings.',
					steps: [
