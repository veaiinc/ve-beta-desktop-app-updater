...
function useHover2() {
  ...
  const onMouseEnter = (0, import_react47.useCallback)(() => setHovered(true), []);
  const onMouseLeave = (0, import_react47.useCallback)(() => setHovered(false), []);
...
var useLatest = function useLatest2(value) {
  var ref = import_react308.default.useRef(value);
  index(function() {
    ref.current = value;
  });
  return ref;
...
var useComposedRef = function useComposedRef2(libRef, userRef) {
  var prevUserRef = import_react309.default.useRef();
  return import_react309.default.useCallback(function(instance) {
...
var JsonInput = factory((props, ref) => {
  ...
  const [valid, setValid] = (0, import_react311.useState)(validateJson(_value, deserialize));
...
var MenuDropdown = factory((props, ref) => {
  ...
  const wrapperRef = (0, import_react319.useRef)(null);
  const ctx = useMenuContext();
...
var MenuItem = polymorphicFactory((props, ref) => {
  ...
  const theme = useMantineTheme();
  const { dir } = useDirection();
  const itemRef = (0, import_react320.useRef)(null);
...
var MenuTarget = (0, import_react322.forwardRef)((props, ref) => {
  ...
  return (0, import_jsx_runtime228.jsx)(Popover.Target, { refProp, popupType: "menu", ref, ...others, children: (0, import_react322.cloneElement)(children, {
    onClick,
    onMouseEnter,
    onMouseLeave,
...
function Menu(_props) {
  ...
  const [openedViaClick, setOpenedViaClick] = (0, import_react323.useState)(false);
  const close = () => {
    setOpened(false);
...
function ModalStack({ children }) {
  const [stack, setStack] = (0, import_react332.useState)([]);
  const [maxZIndex, setMaxZIndex] = (0, import_react332.useState)(getDefaultZIndex("modal"));
...
var PillsInput = factory((_props, ref) => {
  ...
  const fieldRef = (0, import_react341.useRef)(null);
...
function usePersistentCallback(cb) {
  var callbackRef = (0, import_react347.useRef)(cb);
  callbackRef.current = cb;
  var persistentCbRef = (0, import_react347.useRef)(function() {
    var args = [], len = arguments.length;
    while (len--) args[len] = arguments[len];
...
function useInternalValues(value, defaultValue, valueIsNumericString, format2, removeFormatting2, onValueChange) {
  ...
  var ref = (0, import_react347.useState)(function() {
  ...
  (0, import_react347.useMemo)(function() {
    setValues(newValues);
...
function NumberFormatBase(props) {
  ...
  var caretPositionBeforeChange = (0, import_react347.useRef)();
  var lastUpdatedValue = (0, import_react347.useRef)({ formattedValue, numAsString });
  ...
  var ref$1 = (0, import_react347.useState)(false);
  var mounted = ref$1[0];
  var setMounted = ref$1[1];
  var focusedElm = (0, import_react347.useRef)(null);
  var timeout = (0, import_react347.useRef)({
    setCaretTimeout: null,
    focusTimeout: null
  });
  (0, import_react347.useEffect)(function() {
    setMounted(true);
    return function() {
  ...
  var useIsomorphicLayoutEffect2 = typeof window !== "undefined" ? import_react347.useLayoutEffect : import_react347.useEffect;
  ...
  if (displayType === "text") {
    return renderText ? import_react347.default.createElement(import_react347.default.Fragment, null, renderText(formattedValue, otherProps) || null) : import_react347.default.createElement("span", Object.assign({}, otherProps, { ref: getInputRef }), formattedValue);
  } else if (customInput) {
    var CustomInput = customInput;
    return import_react347.default.createElement(CustomInput, Object.assign({}, inputProps, { ref: getInputRef }));
  }
  return import_react347.default.createElement("input", Object.assign({}, inputProps, { ref: getInputRef }));
}
...
function NumericFormat(props) {
  ...
  return import_react347.default.createElement(NumberFormatBase, Object.assign({}, numericFormatProps));
}
...
var NumberInput = factory((_props, ref) => {
  ...
  const inputRef = (0, import_react349.useRef)(null);
  const onStepTimeoutRef = (0, import_react349.useRef)(null);
  const stepCountRef = (0, import_react349.useRef)(0);
  ...
  const incrementRef = (0, import_react349.useRef)(noop);
  ...
  const decrementRef = (0, import_react349.useRef)(noop);
...
function createEdgeComponent({ icon, name, action, type }) {
  ...
  const Component = (0, import_react353.forwardRef)((props, ref) => {
...
var PinInput = factory((props, ref) => {
  ...
  const [focusedIndex, setFocusedIndex] = (0, import_react357.useState)(-1);
  ...
  const inputsRef = (0, import_react357.useRef)([]);
  const validate = (code) => {
  ...
  return (0, import_jsx_runtime265.jsxs)(import_jsx_runtime265.Fragment, { children: [
    (0, import_jsx_runtime265.jsx)(
      Group,
      {
        ...
        __size: size2,
        dir: "ltr",
        children: _value.map((char, index3) => (0, import_react357.createElement)(
          Input,
          {
            component: "input",
            ...getStyles2("pinInput", {
...
var Rating = factory((_props, ref) => {
  ...
  const _name = useId(name);
  const _id = useId(id);
  const rootRef = (0, import_react372.useRef)(null);
  const [_value, setValue] = useUncontrolled({
    value,
    defaultValue,
    finalValue: 0,
  ...
  const [hovered, setHovered] = (0, import_react372.useState)(-1);
  const [isOutside, setOutside] = (0, import_react372.useState)(true);
...
function useFloatingTooltip({
  ...
  const [opened, setOpened] = (0, import_react373.useState)(defaultOpened);
  const boundaryRef = (0, import_react373.useRef)(null);
  ...
  const handleMouseMove = (0, import_react373.useCallback)(
    ({ clientX, clientY }) => {
...
var TooltipFloating = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime283.jsxs)(import_jsx_runtime283.Fragment, { children: [
    ...
    (0, import_react375.cloneElement)(children, {
      ..._childrenProps,
      [refProp]: targetRef,
      onMouseEnter,
      onMouseLeave
...
var TooltipGroupContext = (0, import_react376.createContext)(false);
var TooltipGroupProvider = TooltipGroupContext.Provider;
var useTooltipGroupContext = () => (0, import_react376.useContext)(TooltipGroupContext);
...
function useTooltip(settings) {
  var _a, _b, _c;
  const [uncontrolledOpened, setUncontrolledOpened] = (0, import_react379.useState)(settings.defaultOpened);
  const controlled = typeof settings.opened === "boolean";
  const opened = controlled ? settings.opened : uncontrolledOpened;
  const withinGroup = useTooltipGroupContext();
  const uid = useId();
  const onChange = (0, import_react379.useCallback)(
    (_opened) => {
...
var Tooltip = factory((_props, ref) => {
  ...
  const { dir } = useDirection();
  const arrowRef = (0, import_react381.useRef)(null);
  ...
  return (0, import_jsx_runtime285.jsxs)(import_jsx_runtime285.Fragment, { children: [
    ...
    (0, import_react381.cloneElement)(
      children,
...
var RingProgress = factory((_props, ref) => {
  ...
  const curves = getCurves({
    ...
    rootColor
  }).map(({ data, sum, root, lineRoundCaps, offset: offset2 }, index3) => (0, import_react384.createElement)(
    Curve,
    {
      ...data,
      key: index3,
...
var SegmentedControl = factory((_props, ref) => {
  ...
  const [key, setKey] = (0, import_react385.useState)(randomId());
  const [parent, setParent] = (0, import_react385.useState)(null);
  const [refs, setRefs] = (0, import_react385.useState)({});
  ...
  const controls = _data.map((item) => (0, import_react385.createElement)(
    Box,
    {
      ...getStyles2("control"),
    ...
    (0, import_react385.createElement)(
      "input",
      {
        ...getStyles2("input"),
...
var Select = factory((_props, ref) => {
  ...
  const parsedData = (0, import_react386.useMemo)(() => getParsedComboboxData(data), [data]);
  const optionsLockup = (0, import_react386.useMemo)(() => getOptionsLockup(parsedData), [parsedData]);
  const _id = useId(id);
  const [_value, setValue, controlled] = useUncontrolled({
    value,
    defaultValue,
...
var SliderRoot = (0, import_react392.forwardRef)(
...
var Thumb3 = (0, import_react393.forwardRef)(
  ({
    max,
    min,
    value,
    ...
    const { getStyles: getStyles2 } = useSliderContext();
    const [focused, setFocused] = (0, import_react393.useState)(false);
...
function Marks({ marks, min, max, disabled, value, offset: offset2, inverted }) {
  ...
  const items = marks.map((mark, index3) => (0, import_react394.createElement)(
    Box,
    {
...
var Slider = factory((_props, ref) => {
  ...
  const { dir } = useDirection();
  const [hovered, setHovered] = (0, import_react396.useState)(false);
  const [_value, setValue] = useUncontrolled({
  ...
  const valueRef = (0, import_react396.useRef)(_value);
  const onChangeEndRef = (0, import_react396.useRef)(onChangeEnd);
  (0, import_react396.useEffect)(() => {
    onChangeEndRef.current = onChangeEnd;
  }, [onChangeEnd]);
  const root = (0, import_react396.useRef)(null);
  const thumb = (0, import_react396.useRef)(null);
  const position = getPosition({ value: _value, min, max });
  const scaledValue = scale(_value);
  const _label = typeof label === "function" ? label(scaledValue) : label;
  const precision = _precision ?? getPrecision(step);
  const handleChange = (0, import_react396.useCallback)(
    ({ x }) => {
      if (!disabled) {
  ...
  const handleScrubEnd = (0, import_react396.useCallback)(() => {
  ...
  const callOnChangeEnd = (0, import_react396.useCallback)(
    (value2) => {
      if (!disabled && onChangeEndRef.current) {
...
var RangeSlider = factory((_props, ref) => {
  ...
  const { dir } = useDirection();
  const [focused, setFocused] = (0, import_react397.useState)(-1);
  ...
  const thumbs = (0, import_react397.useRef)([]);
  const root = (0, import_react397.useRef)(null);
  const thumbIndex = (0, import_react397.useRef)(void 0);
  const positions = [
...
var Space = factory((props, ref) => {
  const { w: w2, h, miw, mih, ...others } = useProps("Space", defaultProps164, props);
  return (0, import_jsx_runtime301.jsx)(Box, { ref, ...others, w: w2, miw: miw ?? w2, h, mih: mih ?? h });
});
...
var Stepper = factory((_props, ref) => {
  ...
  const convertedChildren = import_react403.Children.toArray(children);
  ...
  const items = _children.reduce(
    (acc, item, index3) => {
      ...
      acc.push(
        (0, import_react403.cloneElement)(item, {
      ...
      if (orientation === "horizontal" && index3 !== _children.length - 1) {
        acc.push(
          (0, import_react403.createElement)(
            "div",
            {
...
var SwitchGroupContext = (0, import_react404.createContext)(null);
var SwitchGroupProvider = SwitchGroupContext.Provider;
var useSwitchGroupContext = () => (0, import_react404.useContext)(SwitchGroupContext);
...
var TagsInput = factory((_props, ref) => {
  ...
  const parsedData = getParsedComboboxData(data);
  const optionsLockup = getOptionsLockup(parsedData);
  const inputRef = (0, import_react418.useRef)(null);
...
var Timeline = factory((_props, ref) => {
  ...
  const _children = import_react423.Children.toArray(children);
  const items = _children.map(
    (item, index3) => {
      var _a, _b;
      return (0, import_react423.cloneElement)(item, {
        unstyled,
        __align: align,
...
function TreeNode({
  ...
  const ref = (0, import_react426.useRef)(null);
...
function useTree({
  ...
  const [data, setData] = (0, import_react429.useState)([]);
  const [expandedState, setExpandedState] = (0, import_react429.useState)(initialExpandedState);
  const [selectedState, setSelectedState] = (0, import_react429.useState)(initialSelectedState);
  const [checkedState, setCheckedState] = (0, import_react429.useState)(initialCheckedState);
  const [anchorNode, setAnchorNode] = (0, import_react429.useState)(null);
  const [hoveredNode, setHoveredNode] = (0, import_react429.useState)(null);
  const initialize = (0, import_react429.useCallback)(
    (_data) => {
  ...
  const toggleExpanded = (0, import_react429.useCallback)(
    (value) => {
  ...
  const collapse = (0, import_react429.useCallback)(
    (value) => {
      setExpandedState((current) => {
  ...
  const expand = (0, import_react429.useCallback)(
    (value) => {
      setExpandedState((current) => {
  ...
  const expandAllNodes = (0, import_react429.useCallback)(() => {
    setExpandedState((current) => {
      const next = { ...current };
  ...
  const collapseAllNodes = (0, import_react429.useCallback)(() => {
    setExpandedState((current) => {
      const next = { ...current };
      Object.keys(next).forEach((key) => {
        next[key] = false;
  ...
  const toggleSelected = (0, import_react429.useCallback)(
  ...
  const select = (0, import_react429.useCallback)((value) => {
    setAnchorNode(value);
    setSelectedState(
      (current) => multiple ? current.includes(value) ? current : [...current, value] : [value]
    );
  }, []);
  const deselect = (0, import_react429.useCallback)((value) => {
    anchorNode === value && setAnchorNode(null);
    setSelectedState((current) => current.filter((item) => item !== value));
  }, []);
  const clearSelected = (0, import_react429.useCallback)(() => {
    setSelectedState([]);
    setAnchorNode(null);
  }, []);
  const checkNode = (0, import_react429.useCallback)(
    (value) => {
  ...
  const uncheckNode = (0, import_react429.useCallback)(
    (value) => {
      const checkedNodes = getChildrenNodesValues(value, data);
  ...
  const checkAllNodes = (0, import_react429.useCallback)(() => {
    setCheckedState(() => getAllChildrenNodes(data));
  }, [data]);
  const uncheckAllNodes = (0, import_react429.useCallback)(() => {
    setCheckedState([]);
  }, []);
...
var Tree = factory((_props, ref) => {
  ...
  const flatValues = (0, import_react430.useMemo)(() => getFlatValues(data), [data]);
...
var Ie = (e) => te(Re, e, true);
var ne = (e) => (0, import_jsx_runtime334.jsxs)(Stack, { gap: 0, className: "bn-tooltip", children: [
  (0, import_jsx_runtime334.jsx)(Text, { size: "sm", lineClamp: 5, children: e.mainTooltip }),
  e.secondaryTooltip && (0, import_jsx_runtime334.jsx)(Text, { size: "xs", lineClamp: 5, children: e.secondaryTooltip })
] });
var I = (0, import_react433.forwardRef)(
  (e, n) => {
    const {
      className: t,
      children: o,
    ...
    gc(p, false);
    const [N, y] = (0, import_react433.useState)(false), R = o ? (0, import_jsx_runtime334.jsx)(
      Button,
      {
        "aria-label": g,
        className: t,
        onMouseDown: (C) => {
          bc() && C.currentTarget.focus();
        },
        onClick: (C) => {
          y(true), c == null || c(C);
        },
    ...
    return r ? (0, import_jsx_runtime334.jsx)(
      Tooltip,
      {
        disabled: N,
        withinPortal: false,
        label: (0, import_jsx_runtime334.jsx)(
          ne,
          {
            mainTooltip: r,
            secondaryTooltip: i
...
var De = (0, import_react433.forwardRef)((e, n) => {
  const {
    className: t,
    text: o,
    icon: r,
  ...
  gc(g, false);
  const [h, p] = (0, import_react433.useState)(false), N = (0, import_jsx_runtime334.jsxs)(
    Chip,
    {
      className: t,
      checked: i === true,
      ...
      ref: n,
      children: [
        (0, import_jsx_runtime334.jsx)("span", { children: r }),
        (0, import_jsx_runtime334.jsx)("span", { children: o })
      ]
    }
  );
  return !l || h ? N : (0, import_jsx_runtime334.jsx)(
    Tooltip,
    {
      refProp: "rootRef",
      withinPortal: false,
...
var Le = (0, import_react433.forwardRef)((e, n) => {
  const { className: t, children: o, ...r } = e;
  return gc(r), (0, import_jsx_runtime334.jsx)(Group, { className: t, ref: n, children: o });
});
var Be = (0, import_react433.forwardRef)((e, n) => {
  const {
    className: t,
    children: o,
    headerText: r,
  ...
  gc(c, false);
  const g = (0, import_react433.useRef)(null);
  return (0, import_react433.useEffect)(() => {
    var h;
    i && ((h = g.current) == null || h.scrollIntoView({
      behavior: "smooth",
      block: "center"
    }));
  }, [i]), (0, import_jsx_runtime334.jsxs)(
    Card,
    {
      className: Q(t, i ? "selected" : ""),
      onFocus: l,
      onBlur: a,
      tabIndex: u,
      ref: Po([n, g]),
      children: [
        r && (0, import_jsx_runtime334.jsx)(Text, { className: "bn-header-text", children: r }),
        o
      ]
    }
  );
});
var Ee = (0, import_react433.forwardRef)((e, n) => {
  const { className: t, children: o, ...r } = e;
  return gc(r, false), (0, import_jsx_runtime334.jsx)(Card.Section, { className: t, ref: n, children: o });
});
var ze = (0, import_react433.forwardRef)((e, n) => {
  const { className: t, children: o, ...r } = e;
  return gc(r, false), (0, import_jsx_runtime334.jsx)(
    Divider,
    {
      className: t,
      label: (0, import_jsx_runtime334.jsx)(Text, { children: o }),
      ref: n
    }
  );
});
var je = (0, import_react433.forwardRef)((e, n) => {
  const { authorInfo: t, timeString: o, edited: r, ...i } = e;
  return gc(i, false), t === "loading" ? (0, import_jsx_runtime334.jsxs)(Group, { children: [
    (0, import_jsx_runtime334.jsx)(Skeleton, { height: 24, width: 24 }),
    (0, import_jsx_runtime334.jsx)("div", { children: (0, import_jsx_runtime334.jsx)(Skeleton, { height: 12, width: 100 }) })
  ] }) : (0, import_jsx_runtime334.jsxs)(Group, { children: [
    (0, import_jsx_runtime334.jsx)(
      Avatar,
      {
        src: t.avatarUrl,
    ...
    (0, import_jsx_runtime334.jsxs)(Text, { fz: "sm", fw: "bold", children: [
      t.username,
      (0, import_jsx_runtime334.jsxs)(Text, { fz: "xs", c: "dimmed", span: true, ml: "xs", children: [
        o,
        " ",
        r && "(edited)"
      ] })
...
var $e = (0, import_react433.forwardRef)((e, n) => {
  const {
    className: t,
    showActions: o,
    authorInfo: r,
    ...
    children: u,
    ...c
  } = e, { hovered: g, ref: h } = useHover2(), { focused: p, ref: N } = useFocusWithin(), y = Po([n, h]);
  return gc(c, false), (0, import_jsx_runtime334.jsxs)(Group, { pos: "relative", ref: y, className: t, children: [
    a && (o === true || o === void 0 || o === "hover" && g || p) ? (0, import_jsx_runtime334.jsx)(
      Group,
      {
        ref: N,
        style: {
    ...
    (0, import_jsx_runtime334.jsx)(je, { ...e }),
    u
  ] });
});
var Ae = (0, import_react433.forwardRef)((e, n) => {
  const { className: t, autoFocus: o, onFocus: r, onBlur: i, editor: l, editable: a, ...u } = e;
  return gc(u, false), (0, import_jsx_runtime334.jsx)(
    Mt,
    {
      autoFocus: o,
      className: t,
      ...
      onFocus: r,
      onBlur: i,
      children: (0, import_jsx_runtime334.jsx)(
        or,
        {
...
var _e = () => {
  ...
  return (0, import_jsx_runtime334.jsx)(St, { blockTypeSelectItems: [], children: e });
};
var Ve = (0, import_react433.forwardRef)((e, n) => {
  const {
    className: t,
    name: o,
    label: r,
  ...
  return gc(p), (0, import_jsx_runtime334.jsx)(
    TextInput,
    {
      size: "xs",
      className: t,
...
var G = import_react433.default.createContext && import_react433.default.createContext(oe);
var Ge = ["attr", "size", "title"];
function He(e, n) {
  if (e == null) return {};
  var t = Ke(e, n), o, r;
...
function Ue(e, n, t) {
  return n = We(n), n in e ? Object.defineProperty(e, n, { value: t, enumerable: true, configurable: true, writable: true }) : e[n] = t, e;
}
function We(e) {
  var n = qe(e, "string");
...
function re(e) {
  return e && e.map((n, t) => import_react433.default.createElement(n.tag, M({
    key: t
  }, n.attr), re(n.child)));
}
function se(e) {
  return (n) => import_react433.default.createElement(Ze, F({
    attr: M({}, e.attr)
  }, n), re(e.child));
}
function Ze(e) {
  var n = (t) => {
    ...
    return t.className && (u = t.className), e.className && (u = (u ? u + " " : "") + e.className), import_react433.default.createElement("svg", F({
      stroke: "currentColor",
      fill: "currentColor",
      strokeWidth: "0"
    }, t.attr, o, l, {
      ...
      width: a,
      xmlns: "http://www.w3.org/2000/svg"
    }), i && import_react433.default.createElement("title", null, i), e.children);
  };
  return G !== void 0 ? import_react433.default.createElement(G.Consumer, null, (t) => n(t)) : n(oe);
}
function Je(e) {
...
var ie = (0, import_react433.createContext)(void 0);
var Xe = (0, import_react433.forwardRef)((e, n) => {
  const {
    children: t,
    onOpenChange: o,
    position: r,
  ...
  gc(l);
  const [a, u] = (0, import_react433.useState)(false), c = (0, import_react433.useRef)(null), g = (0, import_react433.useRef)(), h = (0, import_react433.useCallback)(() => {
    g.current && clearTimeout(g.current), g.current = setTimeout(() => {
      u(false);
    }, 250);
  }, []), p = (0, import_react433.useCallback)(() => {
    g.current && clearTimeout(g.current), u(true);
  }, []);
  return (0, import_jsx_runtime334.jsx)(
    ie.Provider,
    {
      value: {
        onMenuMouseOver: p,
...
var Ye = (e) => {
  ...
  return gc(i), r ? (0, import_jsx_runtime334.jsx)(Xe, { ...e }) : (0, import_jsx_runtime334.jsx)(
    Menu,
    {
      withinPortal: false,
      middlewares: { flip: true, shift: true, inline: false, size: true },
...
var et = (0, import_react433.forwardRef)((e, n) => {
  const { className: t, children: o, icon: r, checked: i, subTrigger: l, onClick: a, ...u } = e;
  return gc(u, false), l ? (0, import_jsx_runtime334.jsxs)(
    "div",
    {
      onClick: (c) => {
      ...
      children: [
        o,
        (0, import_jsx_runtime334.jsx)(Qe, { size: 15 })
      ]
    }
  ) : (0, import_jsx_runtime334.jsx)(
    Menu.Item,
    {
      ...
      ref: n,
      leftSection: r,
      rightSection: i ? (0, import_jsx_runtime334.jsx)(CheckIcon, { size: 10 }) : i === false ? (0, import_jsx_runtime334.jsx)("div", { className: "bn-tick-space" }) : null,
      onClick: a,
      ...u,
      children: o
    }
...
var tt = (e) => {
  ...
  return gc(o), (0, import_jsx_runtime334.jsx)(Menu.Target, { children: n });
};
var nt = (0, import_react433.forwardRef)((e, n) => {
  const {
    className: t,
    children: o,
    sub: r,
  ...
  gc(i);
  const l = (0, import_react433.useContext)(ie);
  return (0, import_jsx_runtime334.jsx)(
    Menu.Dropdown,
    {
      className: t,
...
var ot = (0, import_react433.forwardRef)((e, n) => {
  const { className: t, ...o } = e;
  return gc(o), (0, import_jsx_runtime334.jsx)(Menu.Divider, { className: t, ref: n });
});
var rt = (0, import_react433.forwardRef)((e, n) => {
  const { className: t, children: o, ...r } = e;
  return gc(r), (0, import_jsx_runtime334.jsx)(Menu.Label, { className: t, ref: n, children: o });
});
var st = (0, import_react433.forwardRef)((e, n) => {
  const {
    className: t,
    children: o,
    icon: r,
  ...
  return gc(g, false), r ? (0, import_jsx_runtime334.jsx)(
    ActionIcon,
    {
      size: 24,
      className: t,
...
var it = (0, import_react433.forwardRef)((e, n) => {
  const {
    className: t,
    tabs: o,
    defaultOpenTab: r,
  ...
  return gc(u), (0, import_jsx_runtime334.jsx)(Group, { className: t, ref: n, children: (0, import_jsx_runtime334.jsxs)(
    Tabs,
    {
      value: i,
      defaultValue: r,
      onChange: l,
      children: [
        a && (0, import_jsx_runtime334.jsx)(LoadingOverlay, { visible: a }),
        (0, import_jsx_runtime334.jsx)(Tabs.List, { children: o.map((c) => (0, import_jsx_runtime334.jsx)(
          Tabs.Tab,
          {
        ...
        o.map((c) => (0, import_jsx_runtime334.jsx)(Tabs.Panel, { value: c.name, children: c.tabPanel }, c.name))
      ]
    }
  ) });
});
var at = (0, import_react433.forwardRef)((e, n) => {
  const { className: t, children: o, onClick: r, label: i, ...l } = e;
  return gc(l), (0, import_jsx_runtime334.jsx)(
    Button,
    {
      size: "xs",
      "aria-label": i,
...
var lt = (0, import_react433.forwardRef)((e, n) => {
  const { className: t, accept: o, value: r, placeholder: i, onChange: l, ...a } = e;
  return gc(a), (0, import_jsx_runtime334.jsx)(
    FileInput,
    {
      size: "xs",
      className: t,
...
var ct = (0, import_react433.forwardRef)((e, n) => {
  const { className: t, children: o, ...r } = e;
  return gc(r), (0, import_jsx_runtime334.jsx)("div", { className: t, ref: n, children: o });
});
var ut = (0, import_react433.forwardRef)((e, n) => {
...
var dt = (e) => {
  ...
  return gc(r), (0, import_jsx_runtime334.jsx)(Popover, { withinPortal: false, opened: n, position: t, children: o });
};
var mt = (e) => {
  const { children: n, ...t } = e;
  return gc(t), (0, import_jsx_runtime334.jsx)(PopoverTarget, { children: n });
};
var ft = (0, import_react433.forwardRef)((e, n) => {
  const {
    className: t,
    children: o,
    variant: r,
  ...
  return gc(i), (0, import_jsx_runtime334.jsx)(PopoverDropdown, { className: t, ref: n, children: o });
});
var gt = (0, import_react433.forwardRef)((e, n) => {
  const { className: t, children: o, ...r } = e;
  return gc(r, false), (0, import_jsx_runtime334.jsx)(
    Group,
    {
...
var ht = (0, import_react433.forwardRef)((e, n) => {
  const {
    className: t,
    children: o,
    icon: r,
...
var bt = (0, import_react433.forwardRef)((e, n) => {
  const { className: t, children: o, id: r, ...i } = e;
  return gc(i), (0, import_jsx_runtime334.jsx)(
    Stack,
    {
      gap: 0,
      className: t,
...
var pt = (0, import_react433.forwardRef)((e, n) => {
  const { className: t, children: o, ...r } = e;
  return gc(r), (0, import_jsx_runtime334.jsx)(Group, { className: t, ref: n, children: (0, import_jsx_runtime334.jsx)(Group, { className: "bn-mt-suggestion-menu-item-title", children: o }) });
});
var vt = (0, import_react433.forwardRef)((e, n) => {
  const { className: t, isSelected: o, onClick: r, item: i, id: l, ...a } = e;
  gc(a);
  const u = (0, import_react433.useRef)(null);
  return (0, import_react433.useEffect)(() => {
    if (!u.current || !o)
      return;
    const c = Qi(
  ...
  }, [o]), (0, import_jsx_runtime334.jsxs)(
    Group,
    {
      gap: 0,
      className: t,
      ...
      children: [
        i.icon && (0, import_jsx_runtime334.jsx)(
          Group,
          {
        ...
        (0, import_jsx_runtime334.jsxs)(Stack, { gap: 0, className: "bn-mt-suggestion-menu-item-body", children: [
          (0, import_jsx_runtime334.jsx)(Text, { className: "bn-mt-suggestion-menu-item-title", children: i.title }),
          (0, import_jsx_runtime334.jsx)(Text, { className: "bn-mt-suggestion-menu-item-subtitle", children: i.subtext })
        ] }),
        i.badge && (0, import_jsx_runtime334.jsx)(
          Group,
          {
            "data-position": "right",
            className: "bn-mt-suggestion-menu-item-section",
            children: (0, import_jsx_runtime334.jsx)(Badge, { size: "xs", children: i.badge })
          }
        )
      ]
    }
...
var St2 = (0, import_react433.forwardRef)((e, n) => {
  const { className: t, children: o, ...r } = e;
  return gc(r), (0, import_jsx_runtime334.jsx)(Group, { className: t, ref: n, children: o });
});
var yt = (0, import_react433.forwardRef)((e, n) => {
  const {
    className: t,
    children: o,
  ...
  return gc(r), (0, import_jsx_runtime334.jsx)(Loader, { className: t, type: "dots", ref: n });
});
var xt = (0, import_react433.forwardRef)((e, n) => {
...
var Ct = (0, import_react433.forwardRef)((e, n) => {
  ...
  return gc(i), (0, import_jsx_runtime334.jsx)(
    Group,
    {
      ...
      ref: n,
      children: (0, import_jsx_runtime334.jsx)(Group, { className: "bn-mt-suggestion-menu-item-title", children: o })
    }
  );
});
var wt = (0, import_react433.forwardRef)((e, n) => {
  const { className: t, isSelected: o, onClick: r, item: i, id: l, ...a } = e;
  gc(a);
  const u = (0, import_react433.useRef)(null);
  return (0, import_react433.useEffect)(() => {
...
var Tt = (0, import_react433.forwardRef)((e, n) => {
  const {
    className: t,
    children: o,
    // unused, using "dots" instead
...
var Nt = (0, import_react433.forwardRef)((e, n) => {
  ...
  return gc(l, false), (0, import_jsx_runtime334.jsx)(
    Button,
    {
      className: o,
      ref: n,
...
var kt = (0, import_react433.forwardRef)((e, n) => {
  const {
    className: t,
    children: o,
    draggable: r,
  ...
  return gc(c, false), (0, import_jsx_runtime334.jsx)(
    Button,
    {
      className: t,
      ref: n,
...
var D2 = (0, import_react433.forwardRef)(
  (e, n) => {
    const {
      className: t,
      children: o,
    ...
    gc(a);
    const { ref: u, focused: c } = useFocusWithin(), g = useFocusTrap(c), h = mergeRefs2(n, u, g);
    return (0, import_jsx_runtime334.jsx)(
      Flex,
      {
        className: t,
...
var L = (0, import_react433.forwardRef)((e, n) => {
  const { className: t, items: o, isDisabled: r, ...i } = e;
  gc(i);
  const l = o.filter((a) => a.isSelected)[0];
  return l ? (0, import_jsx_runtime334.jsxs)(
    Menu,
    {
      withinPortal: false,
      transitionProps: {
      ...
      middlewares: { flip: true, shift: true, inline: false, size: true },
      children: [
        (0, import_jsx_runtime334.jsx)(Menu.Target, { children: (0, import_jsx_runtime334.jsx)(
          Button,
          {
            onMouseDown: (a) => {
              bc() && a.currentTarget.focus();
            },
            leftSection: l.icon,
            rightSection: (0, import_jsx_runtime334.jsx)(Je, {}),
            size: "xs",
            variant: "subtle",
            disabled: r,
            children: l.text
        ...
        (0, import_jsx_runtime334.jsx)(Menu.Dropdown, { className: t, ref: n, children: o.map((a) => (0, import_jsx_runtime334.jsx)(
          Menu.Item,
          {
            onClick: a.onClick,
            leftSection: a.icon,
            rightSection: a.isSelected ? (0, import_jsx_runtime334.jsx)(CheckIcon, { size: 10, className: "bn-tick-icon" }) : (
              // Ensures space for tick even if item isn't currently selected.
              (0, import_jsx_runtime334.jsx)("div", { className: "bn-tick-space" })
            ),
...
var Pt = {
  ...
  Generic: {
    ...
    Form: {
      Root: (e) => (0, import_jsx_runtime334.jsx)("div", { children: e.children }),
      TextInput: Ve
    },
    Menu: {
      Root: Ye,
...
var Mt = (e) => {
  const { className: n, theme: t, ...o } = e, r = D(), i = Xr(), l = (r == null ? void 0 : r.colorSchemePreference) || i, a = (0, import_react433.useCallback)(
    (c) => {
  ...
  return (0, import_jsx_runtime334.jsx)(On.Provider, { value: Pt, children: (0, import_jsx_runtime334.jsx)(
    MantineProvider,
    {
      theme: Ft,
