...
const Skew = ({ activeComponent, adjustAnimation }) => {
	...
	return (
		<div className="adj-popup-container">
			<div className="adj-anime-type">
				<p className="adj-anime-name">Skew</p>
			</div>
				...
				<div className="adj-popup-range-div">
					...
					>
						<input
							...
							max="50"
							step="1"
							value={activeComponent?.animations?.adjustments?.skew || angle}
							onChange={(e) => {
								setAngle(e.target.value);
								adjustAnimation('skew', e.target.value, 'skew');
							}}
						/>
					</div>
					<div className="adj-slider-value">
						{activeComponent?.animations?.adjustments?.skew || angle}°
					</div>
				</div>
			</div>
