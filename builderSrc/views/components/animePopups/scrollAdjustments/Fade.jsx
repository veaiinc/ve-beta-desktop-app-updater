...
const Fade = ({ activeComponent, adjustAnimation }) => {
	...
	return (
		<div className="adj-popup-container">
			<div className="adj-anime-type">
				<p className="adj-anime-name">Fade</p>
			</div>
			...
			<div className="adj-popup-shapes-range-wrapper">
				<b className="adj-adjustment-title">Opacity</b>
				<div className="adj-popup-range-div">
					<div className="adj-slider-container">
						<input
							...
							max="100"
							step="1"
							value={activeComponent?.animations?.adjustments?.opacity || opacity}
							onChange={(e) => {
								adjustAnimation('opacity', e.target.value, 'opacity');
								setOpacity(e.target.value);
							}}
						/>
					</div>
					<div className="adj-slider-value">
						{activeComponent?.animations?.adjustments?.opacity || opacity}
						<span className="adj-units">%</span>
					</div>
				</div>
			</div>
