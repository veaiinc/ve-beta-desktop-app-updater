        ...
        return (
            <div className="service-popup-container element_image_container_main element-shapes-container">
                <div className="service-popup-header">
                    <div onClick={() => this.handleSetEventModule('block')}
                        className={`service-popup-header-title ${this.state.activeModule === 'block' ? 'active' : ''}`}
                    >
                        Block
                    </div>
                    <div onClick={() => this.handleSetEventModule('design')}
                        className={`service-popup-header-title ${this.state.activeModule === 'design' ? 'active' : ''}`}
                    >
                        Design
                    </div>
                </div>
                        ...
                        <>
                            ...
                            <div className="padding-options-wrapper">
                                ...
                                <div className="padding-options-item">
                                    <div className={`padding-one ${!_.has(this.props?.activeComponent?.style, 'padding') || this.props?.activeComponent?.style?.padding === 0 ? 'active' : ''}`} onClick={() => this.handleEventCardStyles('padding', 0)}>null</div>
                                    <div className={`padding-one ${this.props?.activeComponent?.style?.padding == 1 ? 'active' : ''}`} onClick={() => this.handleEventCardStyles('padding', 1)}>S</div>
                                    <div className={`padding-one ${this.props?.activeComponent?.style?.padding == 2 ? 'active' : ''}`} onClick={() => this.handleEventCardStyles('padding', 2)}>M</div>
                                    <div className={`padding-one ${this.props?.activeComponent?.style?.padding == 3 ? 'active' : ''}`} onClick={() => this.handleEventCardStyles('padding', 3)}>L</div>
                                    <div className={`padding-one ${this.props?.activeComponent?.style?.padding == 4 ? 'active' : ''}`} onClick={() => this.handleEventCardStyles('padding', 4)}>XL</div>
                                </div>
                            </div>
                            {/* <div className="padding-options-wrapper">
                                <div className="padding-options-header">
                          ...
                          />
                            ...
                            >
                                <span
                                    className={
                                        `bg-item ` +
                                        (this.props?.activeComponent?.style?.backgroundType === 'background'
                                            ? ' active-bg-type'
                                            : '')
                                    }
                                    onClick={() =>
                            ...
                            {this.state.activeBgtype == 'background' ? (
                                ...
                                <>
                                    ...
                                    <div className="element_image">
                                        ...
                                        >
                                            <span style={{ color: '#7c7c84', fontSize: '12px', fontWeight: '500', fontFamily: 'Inter' }} > Selects from Library</span>
                                        </div>
                                    </div>
                                </>
                            ) : this.state?.activeBgtype == 'video' ? (
