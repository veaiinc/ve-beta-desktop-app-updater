					...
					{this.state?.active === 'd' ? (
						<>
							<div
								...
								className="padding-options-wrapper"
							>
								...
								<div className="padding-options-item">
									<div
										...
										onClick={() => this.handleSummaryStyles(null, 'padding', 0)}
									>
										Null
									</div>
									<div
										...
										onClick={() => this.handleSummaryStyles(null, 'padding', 1)}
									>
										S
									</div>
									<div
										...
										onClick={() => this.handleSummaryStyles(null, 'padding', 2)}
									>
										M
									</div>
									<div
										...
										onClick={() => this.handleSummaryStyles(null, 'padding', 3)}
									>
										L
									</div>
									<div
										...
										onClick={() => this.handleSummaryStyles(null, 'padding', 4)}
									>
										XL
									</div>
								</div>
							...
							<div className="padding-options-wrapper">
								...
								<div className="padding-options-item">
									<div
										...
										onClick={() =>
											this.handleSummaryStyles(null, 'paddingHorizontal', 0)
										}
									>
										Null
									</div>
									<div
										...
										onClick={() =>
											this.handleSummaryStyles(null, 'paddingHorizontal', 1)
										}
									>
										S
									</div>
									<div
										...
										onClick={() =>
											this.handleSummaryStyles(null, 'paddingHorizontal', 2)
										}
									>
										M
									</div>
									<div
										...
										onClick={() =>
											this.handleSummaryStyles(null, 'paddingHorizontal', 3)
										}
									>
										L
									</div>
									<div
										...
										onClick={() =>
											this.handleSummaryStyles(null, 'paddingHorizontal', 4)
										}
									>
										XL
									</div>
