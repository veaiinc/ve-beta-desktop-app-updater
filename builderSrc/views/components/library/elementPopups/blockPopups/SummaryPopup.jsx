								...
								<>
									...
									>
										...
										<Dropdown
											style={{
												cursor: 'pointer',
												rotate: !this.state.showFontsDropDown
													? '0deg'
													: '180deg',
											}}
										/>
									...
									{this.state.showFontsDropDown ? (
										<>
											<div className="fonts-dropdown" ref={this.fontDivRef}>
												<div
													style={{
														width: '100%',
														position: 'sticky',
