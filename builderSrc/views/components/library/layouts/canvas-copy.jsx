...
class LayoutCanvas extends Component {
	constructor(props) {
		...
		this.state = {
			gridCols:
				props.previewMode === 'ml'
					? GRID_CONSTANTS.MOBILE_COLS
					: GRID_CONSTANTS.DESKTOP_COLS,
	...
	handleDrag = (e, data, component) => {
		...
		const gridArea = `${row + 1} / ${col + 1} / ${row + componentDimensions.height + 1} / ${
			col + componentDimensions.width + 1
		}`;
	...
	render() {
		...
		return (
			<div className="layout-container" ref={this.containerRef}>
				<div
