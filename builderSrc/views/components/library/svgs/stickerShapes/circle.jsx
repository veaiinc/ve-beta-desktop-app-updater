...
const CircleSticker = ({ stickerFill, stickerStroke, preserveAspectRatio }) => {
    ...
    return (
        ...
        >
            <path d="M132.5 263.273C204.573 263.273 263 204.847 263 132.773C263 60.7003 204.573 2.27344 132.5 2.27344C60.4268 2.27344 2 60.7003 2 132.773C2 204.847 60.4268 263.273 132.5 263.273Z"
