...
const actionHandlers = {
	...
	GET_SMART_FILE_VARIABLES_DATA_SUCCESS: (state, action) => ({
		...state,
		smartFileVariablesData: action?.payload,
	}),
	GET_WORKFLOW_INFO_SUCCESS: (state, action) => ({
		...state,
		workflowInfoDetails: action?.payload,
	}),
	...
	GET_SMART_FILE_ACTIVITY_SUCCESS: (state, action) => ({
		...state,
		smartFileActivity: action?.payload,
	}),
