...
try {
	...
	console.log(
		'   1. Import: const VEVoiceIntegration = require("./notchdrop-addon/ve-voice-integration");',
	);
	console.log(
		'   2. Setup: const veVoice = VEVoiceIntegration.createIntegration(notchDropService);',
	);
	console.log(
		'   3. Configure auth: veVoice.setAuthContext(workspaceId, userToken, locationDetails);',
	);
