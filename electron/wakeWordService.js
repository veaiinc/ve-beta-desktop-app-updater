        ...
        try {
            ...
            this.process.on('error', (error) => {
                ...
                if (error.code === 'ENOENT') {
                    log.error('Python not found. Please install Python 3.7+ and ensure it\'s in your PATH.');
                    log.error('Visit https://www.python.org/downloads/ to install Python.');
                } else if (error.code === 'EACCES') {
                    log.error('Permission denied. Please check Python installation and permissions.');
                } else {
